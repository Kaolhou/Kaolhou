...
const Posts: NextPage<GetSPPostQueryResponse> = function (
        ...
        error
          ...
          : data?.posts2.length !== 0 && (
              <div className="py-3 my-5">
                ...
                <h1>
                  <Link href="/posts">Postagens Recentes</Link>
                </h1>
                    ...
                    if (key === 6) {
                      return (
                        <Link
                          href="/posts"
                          key={key}
                          className="hover:text-pallete-1 transition-colors underline underline-offset-4 w-20 ml-6 mt-4"
                        >
                          Leia mais...
                        </Link>
                      );
                    }
                    return <PostsLinks i={i} key={key} index={key} />;
                  })}
                </ul>
              </div>
            )
